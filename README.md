...
> Hinweis zur Versionierung: `package.json`/`app-version.js` führen `1.0.0`; der
> `v1.0.0`-Git-Tag wird operator-gated beim Go-Live gesetzt. Ältere Einträge
> (0.8.0, 0.4.x, 0.3.x) stehen vollständig in [`CHANGELOG.md`](CHANGELOG.md).
