...
| | |
|---|---|
| **Status** | Version 1.0.2 „Sushi" — feature-complete, Bugfix-Release |
...
> Hinweis zur Versionierung: `package.json`/`app-version.js` führen `1.0.2`
> (Bugfix-Release). Ältere Einträge (1.0.1, 1.0.0, 0.8.0, 0.4.x, 0.3.x) stehen
> vollständig in [`CHANGELOG.md`](CHANGELOG.md).
