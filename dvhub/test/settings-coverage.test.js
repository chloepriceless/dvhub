...
const INTENTIONAL = new Map([
  ...
  ['wallbox.openevse.url', 'EVCC-Schublade auf der Integrationsseite (Wallbox direkt)'],
  ['wallbox.openevse.username', 'EVCC-Schublade auf der Integrationsseite (Wallbox direkt)'],
  ['wallbox.openevse.password', 'EVCC-Schublade auf der Integrationsseite (Wallbox direkt)'],
  ['wallbox.goe.url', 'EVCC-Schublade auf der Integrationsseite (Wallbox direkt)'],
  ['optimizer.evDepartureEnabled', 'EVCC-Schublade auf der Integrationsseite (E-Auto-Abfahrt)'],
  ['optimizer.evDepartureTime', 'EVCC-Schublade auf der Integrationsseite (E-Auto-Abfahrt)'],
  ['optimizer.evDepartureDays', 'EVCC-Schublade auf der Integrationsseite (E-Auto-Abfahrt)'],
  ['optimizer.evDepartureOnce', 'EVCC-Schublade auf der Integrationsseite (E-Auto-Abfahrt)'],
